...
/**
 * Handle CRUD operation with ScoreCards
 */
public interface ScoreCardRepository extends JpaRepository<ScoreCard, Long> {

    /**
     * Get the total score for a given user, being the sum of the scores of all his ScoreCards
     * @param userId the id of user for which the total score should be retrieved
    ...
    /**
     * Retrieve a list of {@link LeaderBoardRow}s representing the Leader Board of users and their total score.
